var SamCoinCrowdsale = artifacts.require("./SamCoinCrowdsale.sol")
...
module.exports = function(deployer, network, accounts) {
  ...
  const rate = new web3.BigNumber(1000) // rate of ether to Sam Coin in wei
  const wallet = web3.eth.accounts[0] // the address that will hold the fund. Recommended to use a multisig one for security.

  deployer.deploy(SamCoinCrowdsale, startBlock, endBlock, rate, wallet)
}